...
[⬇ Download the latest release (.vsix)](https://github.com/terryaney/Extensibility.VS.Code.Comment.Studio/raw/main/dist/kat-comment-studio-1.0.14.vsix)
...
1. [Download the extension](https://github.com/terryaney/Extensibility.VS.Code.Comment.Studio/raw/main/dist/kat-comment-studio-1.0.14.vsix).
...
3. Browse to the downloaded `kat-comment-studio-1.0.14.vsix` and select it.
